...
ECHO======================================================================================
SET KIT_NAME=image_segmentation
...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/image_segmentation/releases/download/v1.0.0/image_segmentation.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/image_segmentation/raw/main/requirements.txt
SET REPO_NAME=image_segmentation.zip
SET EXTRACTED_REPO_DIR=image_segmentation
SET NOTEBOOK_NAME=Image_Segmentation.ipynb
SET MS_VC_REDIST_URL=https://aka.ms/vs/17/release/vs_BuildTools.exe
SET GET_PIP_LOCATION=https://bootstrap.pypa.io/get-pip.py
SET VIRTUALENV_NAME=image_segmentation-env
...
curl https://kandi.dev/owassets/kandi1clickkits-model-assets/imagesegmentation/sam_vit_h_4b8939.pth --output sam_vit_h_4b8939.pth >> !WORKING_DIR!\log.txt 2>&1
IF ERRORLEVEL 1 (
